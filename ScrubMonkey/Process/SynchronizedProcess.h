...
{
public:
	SynchronizedProcess(std::string taskName, INT32 priority=Task::kDefaultPriority);
	SynchronizedProcess(std::string taskName, SEM_ID syncSem, INT32 priority=Task::kDefaultPriority);
