#ifndef RHESUS_MSG_BUFFER_H_
#define RHESUS_MSG_BUFFER_H_
...
namespace Messenger
{
	...
	public:
		/*!
		 * @brief Initializes the MessageBuffer.
		 */
		MessageBuffer();
		
		/*!
		 * @brief Initializes the MessageBuffer with a buffer size of bufferDefaultSize.
		 */
		MessageBuffer(const int bufferDefaultSize);
		
		/*!
		 * @brief Initializes the MessageBuffer with a buffer.
		 */
		MessageBuffer(const UINT8* buff, int len);
		
		/*!
		 * @brief Releases the resources utilized by the MessageBuffer.
		 */
		~MessageBuffer();
