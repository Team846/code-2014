...
Sequential::Sequential(std::string name, bool queueIfBlocked, bool restartable) :
	Automation(name, false, queueIfBlocked, restartable)
{
	started = false;
}

Sequential::Sequential(std::string name, vector<Automation*> sequence, bool queueIfBlocked, bool restartable) :
	Automation(name, false, queueIfBlocked, restartable)
{
	routines = sequence;
	started = false;
